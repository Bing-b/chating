...
#container {
  ...
  .slogan {
    ...
    &::before {
      ...
      width: 300px;
      height: 100px;
      background: linear-gradient(to right, var(--primary-color), #4776E6, #8E54E9);
      z-index: -1;
      filter: blur(70px);
    }
    img {
  ...
  .box {
    ...
    /deep/.el-input__inner {
      ...
      outline: 0px solid var(--light-bg-color);
      &::placeholder {
      ...
      &:focus {
        outline: 3px solid rgba(49, 97, 229, 0.8);
      }
    }
    /deep/.el-button {
      border: none;
      ...
      ul {
        ...
        li {
          ...
          &:hover {
            ...
            border-color: #fff;
            box-shadow: 0px 10px 14px  rgba(0, 0, 0, 10%);
          }
        }
      }
    }
